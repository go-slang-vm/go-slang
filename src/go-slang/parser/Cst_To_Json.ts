...
import { ArgumentsContext, Assign_opContext, AssignmentContext, BINOPContext, BlockContext, EosContext, ExpressionContext, ExpressionListContext, ForStmtContext, FUNCAPPContext, FuncAppContext, FuncDeclContext, Global_scopeContext, IdentifierListContext, IfStmtContext, LiteralContext, LOGOPContext, MultiAssignmentContext, MultiVarDeclContext, OperandContext, OperandNameContext, ParameterDeclContext,ParametersContext, PRIMARYContext, PrimaryExprContext, RELOPContext, ReturnStmtContext, SignatureContext, SimpleStmtContext, StatementContext, StatementListContext, UNARYOPContext, VarDeclContext } from "../lang/SimpleParser";
